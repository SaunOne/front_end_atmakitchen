...
export function PenjualanPerProdukReport({ data }) {
    console.log(data);
    ...
    const handleDownloadPdf = () => {
        ...
        data.data.forEach(({ nama_produk, kuantitas, harga, jumlah_uang }) => {
            const rowData = [nama_produk, kuantitas, harga.toLocaleString('id-ID'), jumlah_uang.toLocaleString('id-ID')];
                    ...
                    <tbody>
                        {data.data.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td className="border border-gray-400 py-2 px-4">
                                    <Typography className="text-xs font-[400] text-blue-gray-600">
                                        {item.jumlah_uang.toLocaleString('id-ID')}
                                    </Typography>
                                </td>
                            </tr>
                        ...
                        <tr>
                            <td colSpan={3} className="border border-gray-400 py-2 px-4 text-right">
                                <Typography className="text-xs font-[400] text-blue-gray-600">
                                    Total
                                </Typography>
                            </td>
