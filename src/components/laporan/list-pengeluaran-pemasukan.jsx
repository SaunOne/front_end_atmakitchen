...
import { GetLaporanPengeluaranPemasukan } from "@/api/laporanApi";
import {  } from "./penjualan-perproduk-report";
import { PresensiGajiReport } from "./presensi-gaji-report";
import { PengeluaranPemasukanReport } from "./pengeluaran-pemasukan-report";

export function PengeluaranPemasukanTable() {
    ...
    useEffect(() => {
        ...
        GetLaporanPengeluaranPemasukan(formattedDate)
            .then((response) => {
        ...
        <>
            ...
            {isLoading ? (
                ...
                <div className="p-2 rounded-lg">
                    <PengeluaranPemasukanReport data={data} />
                </div>
            )}
        </>
    );
