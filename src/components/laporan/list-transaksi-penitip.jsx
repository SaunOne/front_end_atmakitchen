...
import { GetLaporanRekapTransaksi } from "@/api/laporanApi";
import {  } from "./penjualan-perproduk-report";
import { TransaksiPenitipReport } from "./transaksi-penitip-report";

export function TransaksiPenitipTable() {
    ...
    useEffect(() => {
        ...
        GetLaporanRekapTransaksi(formattedDate)
            .then((response) => {
        ...
        <>
            ...
            {isLoading ? (
                ...
                <div className="p-2 rounded-lg">
                    <TransaksiPenitipReport data={data} />
                </div>
            )}
        </>
    );
